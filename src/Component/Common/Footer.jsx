...
const Footer = () => {
  return (
    <footer className="border-t py-12 bg-white">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-6 lg:px-0">
        ...
        {/* Follow Us Section (right side of Support) */}
        <div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <a href="https://www.twitter.com" target="_blank" rel="noopener noreferrer" className="hover:text-sky-500">
              <FaTwitter size={22} />
            </a>
          </div>
          <p className='text-gray-500 mt-4'>Call Us</p>
          <p>
