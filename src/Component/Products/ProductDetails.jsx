...
const selectedProduct = {
    ...
    price: 120,
    orginalPrice: 150,
    description: "this is a stylish jacket perfect for any occasion", // fixed key
    brand: "FashionBrand",
    material: "Leather",
    sizes: ["S", "M", "L", "XL"],
    colors: ["Red", "Black"],
                ...
                <div className='max-w-6xl mx-auto bg-white p-8 rounded-lg'>
                    <div className='flex flex-col md:flex-row '>
                        ...
                        <div className='hidden md:flex flex-col space-y-4 mr-6 '>
                            {selectedProduct.images.map((image, index) => (
                                <img
                                    ...
                                    className={`w-20 h-20 object-cover rounded-lg cursor-pointer border-[1.5px] ${mainImage === image.url ? "border-black" : "border-gray-300"}`}
                        ...
                        <div className='md:w-1/2 md:ml-10'>
                            ...
                            <div className='mb-4'>
                                <p className='text-gray-700'>Colore:</p>
