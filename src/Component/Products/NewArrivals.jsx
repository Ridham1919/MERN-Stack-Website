...
const NewArrivals = () => {
  ...
  const NewArrivals = [
    ...
    },
    {
      ...
      price: 90,
      images: [
        { url: "https://picsum.photos/500/500?random=2", altText: "Trendy Hoodie" }
      ]
    },
    {
      _id: "3",
      ...
      price: 70,
      images: [
        { url: "https://picsum.photos/500/500?random=3", altText: "Casual Shirt" }
      ]
    },
    {
      _id: "4",
    ...
    },
    {
      ...
      price: 150,
      images: [
        { url: "https://picsum.photos/500/500?random=5", altText: "Sneakers" }
      ]
    },
    {
      _id: "6",
      ...
      <div ref={scrollRef} className='container mx-auto overflow-x-scroll flex space-x-6 relative pb-4 scrollbar-hide'>
        {NewArrivals.map((product) => (
          <div key={product._id} className='min-w-[100%] sm:min-w-[50%] lg:min-w-[30%] relative'>
            ...
            />
            <div className='absolute bottom-0 left-0 right-0 bg-orange-50 backdrop-blur-md p-4 rounded-b-lg'>
